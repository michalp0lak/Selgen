#!/usr/bin/env python
# -*- coding: utf-8 -*-# - nastavit ssh RSA key z jednoho kompu na druhý
...
rpistill = 'raspistill -v -n -md 2 -awb ' + awb + ' -ss ' + exp + ' -o '
...
if client.get_transport().is_active():
    ...
    while client.get_transport().is_active():
        ...
        if exit_st1 == 0:
            ...
            print('Foceni ses nepodarilo. Zkontrolujte pripojeni kamery. Exit.')
            client.close()
            exit()
